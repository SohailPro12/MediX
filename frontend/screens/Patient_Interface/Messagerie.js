...
const messages = [
  {
    id: '1',
    name: 'Idward Snowdern',
    role: 'Doctor',
    message: 'bonjour mon patient ',
    unread: true,
    imageUrl:require('../../assets/Patient.jpeg')
  },
  {
    id: '2',
    name: 'mohammed majid',
    ...
    unread: false,
    imageUrl:require('../../assets/Patient2.jpeg')
  },
];
...
export default function MessageListScreen() {
  ...
  return (
    ...
    <Header param="messagerie"  rja3="DashboardPatient"/>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#F9FAFC', paddingTop: 5},
