...
const {
  ...
  address='',
  about = 'Aucune information fournie.',
  image='',
  formation ,
  experience ,
} = passedDoctor || {};
const safeFormation = typeof formation === 'string' ? formation.split(',') : Array.isArray(formation) ? formation : [];
const safeExperience = typeof experience === 'string' ? experience.split(',') : Array.isArray(experience) ? experience : [];
